    ...
    <div class="d-flex" style=" background-color: rgb(255, 255, 255);">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="double_col box_input">
                ...
                <input id="lastname" class="registro_input" type="text" name="lastname" :value="old('lastname')"/>
            </div>
            ...
            <div class="double_col box_input">
                <label for="id_especialidades" value="id_especialidades">Especialidad</label>
                {{-- <input id="especialidad" class="registro_input" type="text" name="especialidad" :value="old('id_especialidad')"/> --}}
                <select class="form-select" aria-label="Default select example" name="id_especialidades">
                    <option selected>Select</option>
                    <option value="1">Tecnología Digital</option>
                    <option value="2">Mecatrónica</option>
                    <option value="3">Gestión y Producción</option>
                  </select>
            </div>
